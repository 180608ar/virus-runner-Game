...
var s6,s7,s8,s9,s10,s11,s12,s13,star;
...
function preload(){
  ...
  re = loadImage("reset copy.png");
  gm = loadImage("game over 1.png");
...
function setup(){
  ...
  s8 = createSprite(560,30,2,2);
  s9 = createSprite(630,150,2,2);
  s10 = createSprite(700,100,2,2);
  s11 = createSprite(780,60,2,2);
  s12 = createSprite(850,120,2,2);
  s13 = createSprite(910,130,2,2);
  ...
  restart = createSprite(500,265,20,20);
  restart.addImage(re);
  restart.scale = 0.06;
